      ...
      <div className="mx-auto w-full max-w-7xl">
        <MotionFade>
          <SectionHeading
            ...
            description="Our clinic is committed to providing you with the highest quality of care. We use the latest technology and techniques to ensure you receive the best possible treatment."
          />
        </MotionFade>
        ...
        <div className="relative mt-10 grid items-center lg:grid-cols-[1fr_auto_1fr] lg:gap-12">
          ...
          <MotionFade className="flex flex-col gap-10">
            {leftFeatures.map((item, index) => {
              const Icon = leftIcons[index];
              return (
                <div key={item.title} className="relative flex items-start justify-end gap-3">
          ...
          <MotionFade delay={0.08} className="relative mx-auto flex items-center justify-center py-6">
          ...
          <MotionFade delay={0.12} className="flex flex-col gap-10">
